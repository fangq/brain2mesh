...
%
% [node,elem,face] = vol_bmeshing(seg,res)
% 
...
%   
%   options: radius of the Delaunay sphere (element size)
%            Default is [1.7 1.7 2.0 2.5 3] for WM, GM, CSF, Bone and Scalp, respectively.
%            If values are too large, mesh generation may fail. 
%
%   maxvol: default is 40, indicates the volumetric maximum size of elements
%   ratio: radius-edge ratio, default is 1.414. Lower values increase quality better, 
%          but results in denser meshes
